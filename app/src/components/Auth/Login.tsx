...
const Login = ({ onSwitchToRegister, onSwitch, onSuccess }: LoginProps) => {
    ...
    >
      ...
      >
        ...
        <View style={[globalStyles.card, styles.card]}>
          ...
          <Text style={styles.subtitle}>Sign in to access your AI interview coach & GD prep</Text>
          
          {/* Feature Badges */}
          <View style={styles.featuresRow}>
            <View style={styles.featurePill}>
              <Text style={styles.featurePillText}>🤖 AI Interviews</Text>
            </View>
            <View style={styles.featurePill}>
              <Text style={styles.featurePillText}>⚡ Real-Time Feedback</Text>
            </View>
          </View>
          ...
          <View style={styles.switchContainer}>
            ...
            <TouchableOpacity onPress={() => (onSwitchToRegister ? onSwitchToRegister() : onSwitch?.())}>
